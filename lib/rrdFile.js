...
RRDRRA.prototype = {
	 ...
	 * @private
	 */
	calc_idx : function(row_idx, ds_idx) {
		// do range check
		if ((row_idx < 0) || (row_idx >= this.nrRows)) {
			throw RangeError("Row idx (" + row_idx + ") out of range [0-" + this.nrRows + ").");
		}
		...
		return this.row_size * ((row_idx + this.cur_row + 1) % this.nrRows) + ds_idx * 8;
	},
