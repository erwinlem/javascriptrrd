...
function RRDRRA(rrd_data, rra_ptr_idx, header_size, prev_row_cnts, ds_cnt, nrRows, rra_def_idx, int_width, pdp_step) {
	...
	var rra_pdp_cnt_idx = rra_def_idx + align(20, int_width) + int_width;
