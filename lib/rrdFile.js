 ...
 * @constructor
 */
function RRDRRAInfo(rrd_data, rra_def_idx, int_width, pdp_step, my_idx) {
 ...
 * @constructor
 */
function RRDRRA(rrd_data, rra_ptr_idx, rra_info, header_size, prev_row_cnts, ds_cnt, nrRows) {
	...
	this.data = new Array(ds_cnt).fill(0).map(row => new Array(nrRows));
